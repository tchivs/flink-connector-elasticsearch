...
@Internal
public class ElasticSearch9AsyncDynamicSink extends AsyncDynamicTableSink<Operation> {
    ...
    public SinkRuntimeProvider getSinkRuntimeProvider(Context context) {
        Elasticsearch9AsyncSinkBuilder<RowData> builder = new Elasticsearch9AsyncSinkBuilder<>();
    ...
    public DynamicTableSink copy() {
        return new ElasticSearch9AsyncDynamicSink(
                format,
                config,
    ...
    public boolean equals(Object o) {
        ...
        ElasticSearch9AsyncDynamicSink that = (ElasticSearch9AsyncDynamicSink) o;
    ...
    /** Builder class for {@link ElasticSearch9AsyncDynamicSink}. */
    @Internal
    public static class ElasticSearch9AsyncDynamicSinkBuilder
            extends AsyncDynamicTableSinkBuilder<Operation, ElasticSearch9AsyncDynamicSinkBuilder> {
        ...
        public ElasticSearch9AsyncDynamicSinkBuilder setConfig(Elasticsearch9Configuration config) {
            this.config = config;
            return this;
        }

        public ElasticSearch9AsyncDynamicSinkBuilder setFormat(
                EncodingFormat<SerializationSchema<RowData>> format) {
            this.format = format;
            return this;
        }

        public ElasticSearch9AsyncDynamicSinkBuilder setPhysicalRowDataType(
                DataType physicalRowDataType) {
            this.physicalRowDataType = physicalRowDataType;
            return this;
        }

        public ElasticSearch9AsyncDynamicSinkBuilder setPrimaryKeyLogicalTypesWithIndex(
                List<LogicalTypeWithIndex> primaryKeyLogicalTypesWithIndex) {
            this.primaryKeyLogicalTypesWithIndex = primaryKeyLogicalTypesWithIndex;
            return this;
        }

        public ElasticSearch9AsyncDynamicSinkBuilder setLocalTimeZoneId(ZoneId localTimeZoneId) {
            this.localTimeZoneId = localTimeZoneId;
            return this;
        }

        public ElasticSearch9AsyncDynamicSinkBuilder setSummaryString(String summaryString) {
            this.summaryString = summaryString;
            return this;
        }

        @Override
        public ElasticSearch9AsyncDynamicSink build() {
            return new ElasticSearch9AsyncDynamicSink(
                    format,
                    config,
                    primaryKeyLogicalTypesWithIndex,
