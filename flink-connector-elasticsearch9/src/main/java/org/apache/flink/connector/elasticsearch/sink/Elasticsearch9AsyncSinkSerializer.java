...
/** Elasticsearch9AsyncSinkSerializer is used to serialize and deserialize an Operation. */
public class Elasticsearch9AsyncSinkSerializer extends AsyncSinkWriterStateSerializer<Operation> {
