...
/**
 * A {@link DynamicTableSource} that describes how to create a {@link Elasticsearch9DynamicSource}
 * from a logical description.
 */
public class Elasticsearch9DynamicSource
    ...
    protected final Elasticsearch9Configuration config;
    private final String summaryString;
    protected DataType physicalRowDataType;

    public Elasticsearch9DynamicSource(
    ...
    public DynamicTableSource copy() {
        return new Elasticsearch9DynamicSource(format, config, physicalRowDataType, summaryString);
    }
