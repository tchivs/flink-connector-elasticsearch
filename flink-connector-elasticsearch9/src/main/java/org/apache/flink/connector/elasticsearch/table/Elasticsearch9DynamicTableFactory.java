...
import static org.apache.flink.connector.elasticsearch.table.Elasticsearch9ConnectorOptions.BULK_FLUSH_INTERVAL_OPTION;
import static org.apache.flink.connector.elasticsearch.table.Elasticsearch9ConnectorOptions.BULK_FLUSH_MAX_ACTIONS_OPTION;
import static org.apache.flink.connector.elasticsearch.table.Elasticsearch9ConnectorOptions.BULK_FLUSH_MAX_BUFFERED_ACTIONS_OPTION;
import static org.apache.flink.connector.elasticsearch.table.Elasticsearch9ConnectorOptions.BULK_FLUSH_MAX_IN_FLIGHT_ACTIONS_OPTION;
import static org.apache.flink.connector.elasticsearch.table.Elasticsearch9ConnectorOptions.BULK_FLUSH_MAX_SIZE_OPTION;
import static org.apache.flink.connector.elasticsearch.table.Elasticsearch9ConnectorOptions.CONNECTION_PATH_PREFIX_OPTION;
import static org.apache.flink.connector.elasticsearch.table.Elasticsearch9ConnectorOptions.CONNECTION_REQUEST_TIMEOUT;
import static org.apache.flink.connector.elasticsearch.table.Elasticsearch9ConnectorOptions.CONNECTION_TIMEOUT;
import static org.apache.flink.connector.elasticsearch.table.Elasticsearch9ConnectorOptions.DELIVERY_GUARANTEE_OPTION;
import static org.apache.flink.connector.elasticsearch.table.Elasticsearch9ConnectorOptions.FORMAT_OPTION;
import static org.apache.flink.connector.elasticsearch.table.Elasticsearch9ConnectorOptions.HOSTS_OPTION;
import static org.apache.flink.connector.elasticsearch.table.Elasticsearch9ConnectorOptions.INDEX_OPTION;
import static org.apache.flink.connector.elasticsearch.table.Elasticsearch9ConnectorOptions.KEY_DELIMITER_OPTION;
import static org.apache.flink.connector.elasticsearch.table.Elasticsearch9ConnectorOptions.MAX_RETRIES;
import static org.apache.flink.connector.elasticsearch.table.Elasticsearch9ConnectorOptions.NUM_CANDIDATES;
import static org.apache.flink.connector.elasticsearch.table.Elasticsearch9ConnectorOptions.PASSWORD_OPTION;
import static org.apache.flink.connector.elasticsearch.table.Elasticsearch9ConnectorOptions.SOCKET_TIMEOUT;
import static org.apache.flink.connector.elasticsearch.table.Elasticsearch9ConnectorOptions.SSL_CERTIFICATE_FINGERPRINT;
import static org.apache.flink.connector.elasticsearch.table.Elasticsearch9ConnectorOptions.USERNAME_OPTION;
...
/**
 * A factory for discovering both {@link Elasticsearch9DynamicSource} (lookup / vector search) and
 * {@link ElasticSearch9AsyncDynamicSink} under the same {@code elasticsearch-9} identifier.
 */
@Internal
public class Elasticsearch9DynamicTableFactory extends AsyncDynamicTableSinkFactory
        implements DynamicTableSourceFactory {
    private static final String IDENTIFIER = "elasticsearch-9";
    ...
    public DynamicTableSource createDynamicTableSource(Context context) {
        ...
        Elasticsearch9Configuration config = getConfiguration(helper);
        helper.validate();
        validateConfiguration(config);

        return new Elasticsearch9DynamicSource(
    ...
    public DynamicTableSink createDynamicTableSink(Context context) {
        ...
        return new ElasticSearch9AsyncDynamicSink.ElasticSearch9AsyncDynamicSinkBuilder()
                .setConfig(config)
                .setFormat(format)
    ...
    Elasticsearch9Configuration getConfiguration(FactoryUtil.TableFactoryHelper helper) {
        return new Elasticsearch9Configuration(helper.getOptions());
    }

    void validateConfiguration(Elasticsearch9Configuration config) {
