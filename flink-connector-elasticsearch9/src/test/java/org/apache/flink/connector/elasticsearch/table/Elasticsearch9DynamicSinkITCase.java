...
/** IT tests for {@link ElasticSearch9AsyncDynamicSink}. */
@ExtendWith(ParameterizedTestExtension.class)
class Elasticsearch9DynamicSinkITCase extends Elasticsearch9DynamicSinkBaseITCase {
    ...
    public void testWritingDocuments() throws Exception {
        ...
        Elasticsearch9DynamicTableFactory sinkFactory = new Elasticsearch9DynamicTableFactory();
