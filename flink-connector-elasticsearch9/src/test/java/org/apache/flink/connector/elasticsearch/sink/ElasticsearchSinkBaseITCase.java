...
public abstract class ElasticsearchSinkBaseITCase {
    ...
    /** Create an Elasticsearch9AsyncSink for DummyData type against the ES test container. */
    protected Elasticsearch9AsyncSink<DummyData> getSinkForDummyData(String index) {
        final Elasticsearch9AsyncSinkBuilder<DummyData> builder =
    ...
    protected void assertIdsAreWritten(String index, String[] ids)
    ...
    protected void assertIdsAreNotWritten(String index, String[] ids)
            throws IOException, ParseException {
        final String responseEntity = queryElasticsearchIndex(index);
        for (String id : ids) {
    ...
    private Rest5Client createElasticsearchClient() {
        return Rest5Client.builder(getHost()).build();
    }
    ...
    private Rest5Client createSecureElasticsearchClient() {
        ...
        return Rest5Client.builder(getHost())
                ...
                .setSSLContext(ES_CONTAINER_SECURE.createSslContextFromCa())
                .build();
    }

    private String queryElasticsearchIndex(String index) throws IOException, ParseException {
