...
@Testcontainers
public class Elasticsearch9VectorSearchITCase {
    private static final Logger LOG =
            LoggerFactory.getLogger(Elasticsearch9VectorSearchITCase.class);
    ...
    public void testSearchFullTypeVectorTable() throws Exception {
        ...
        // Insert data using ES client since elasticsearch-9 connector doesn't support sink
                        ...
                        d.dims(dims)
                                ...
                                .indexOptions(
                                        DenseVectorIndexOptions.of(
                                                o ->
                                                        o.type(DenseVectorIndexOptionsType.Hnsw)
                                                                .m(16)
                                                                .efConstruction(100))));
    }

    private static DenseVectorSimilarity parseSimilarity(String similarity) {
        switch (similarity) {
            case "cosine":
            ...
            default:
                throw new IllegalArgumentException("Unknown similarity: " + similarity);
        }
    }
